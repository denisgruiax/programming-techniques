/*
    ...
    Fiecare element din listă este un cuvânt de maxim 15 caractere sau un semn de punctuație.
    Programul va avea un meniu cu următoarele opțiuni :
1 - propoziție nouă(introducere cuvinte până la punct, exclusiv);
2 - afișare;
3 - șterge cuvânt;
4 - ieșire
*/
